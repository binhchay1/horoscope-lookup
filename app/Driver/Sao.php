...
$saoTrangSinh = new Sao(39, "Tràng sinh", "T", 5, $vongTrangSinh = 1);
$saoMocDuc = new Sao(40, "Mộc dục", "T", 14, $vongTrangSinh = 1);
$saoQuanDoi = new Sao(41, "Quan đới", "K", 4, $vongTrangSinh = 1);
$saoLamQuan = new Sao(42, "Lâm quan", "K", 7, $vongTrangSinh = 1);
$saoDeVuong = new Sao(43, "Đế vượng", "K", 5, $vongTrangSinh = 1);
$saoSuy = new Sao(44, "Suy", "T", 12, $vongTrangSinh = 1);
$saoBenh = new Sao(45, "Bệnh", "H", 12, $vongTrangSinh = 1);
$saoTu = new Sao(46, "Tử", "H", 12, $vongTrangSinh = 1);
$saoMo = new Sao(47, "Mộ", "O", $vongTrangSinh = 1);
$saoTuyet = new Sao(48, "Tuyệt", "O", 12, $vongTrangSinh = 1);
$saoThai = new Sao(49, "Thai", "O", 14, $vongTrangSinh = 1);
$saoDuong = new Sao(50, "Dưỡng", "M", 2, $vongTrangSinh = 1);
